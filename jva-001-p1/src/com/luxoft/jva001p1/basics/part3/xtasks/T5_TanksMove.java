...
public class T5_TanksMove extends JPanel
{
    ...
    /**
     * Tank should not move over the brick, should just do nothing.
     */
    void move(int direction)
    {
        // TODO YOUR UPDATED CODE HERE
    }
    ...
    {
        T5_TanksMove bf = new T5_TanksMove();
        bf.runTheGame();
    }

    public T5_TanksMove() throws Exception
    {
